...
<p align='center'>   <img alt="Openning Arches for HER demo" src="fig/02-01-home.png" width="1000"/>
</p>
...
Do note that the design of any Arches installation is customisable, including the home page, so the installation used by different organisations may differ. In fact, Arches is so customisable that even the way data is stored can be varied for different solution, which we will cover on the next lesson.

## Find a set Resource from the Demo

We will use the online Arches for HER demo, with several resources preloaded for this exercise.
...
<p align='center'>   <img alt="Search for a Resource" src="fig/02-03-find.png" width="1000"/>
</p>
...
Let's suppose we are trying to find a some historical Railway Stations in the database. First, we can try to find the Resource for Russell Square Station, a historical rail station built during the Edwardian Era. 


<p align='center'>   <img alt="Image of Russell Square Station" src="fig/Misc/Russell_Square_station_wiki_commons.jpg" width="1000"/>
</p>
...
<!-- ![Russell Square Search](fig/02-04-Russell_Square.png) -->
...
<!-- ![Russell Square Refined Search](fig/02-05-Russell_Square.png) -->
...
<!-- ![Russell Square Information](fig/02-06-Russell_Square.png) -->
...
<!-- ![Russell Square Relations](fig/02-07-Relations.png) -->
